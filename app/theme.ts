...
export const flowbiteTheme: CustomFlowbiteTheme = {
  ...
  textInput: {
    base: "flex",
    addon:
      "inline-flex items-center rounded-l-md border border-r-0 border-gray-300 bg-gray-200 px-3 text-sm text-gray-900 dark:border-gray-600 dark:bg-neutral-600 dark:text-gray-400",
    field: {
