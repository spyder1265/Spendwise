...
const Payment = () => {
  ...
  const handlePayment = () => {
    // Add logic to handle the payment (e.g., integrate with a payment gateway)
    ...
    <div className="flex h-screen w-full flex-col items-center justify-around pt-[72px] md:overflow-y-hidden">
      <div className="max-w-2xl p-6 border border-gray-200 rounded-lg shadow dark:border-gray-700">
        ...
        <form className="max-w-sm mx-auto">
          <label htmlFor="cardholder-icon" className="block my-2 text-sm font-medium text-gray-900 dark:text-white">Cardholder Name</label>
          <div className="relative">
            ...
            <input type="text" id="cardholder-icon" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5  dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="John Doe"/>
          </div>
          <label htmlFor="card-number-icon" className="block my-2 text-sm font-medium text-gray-900 dark:text-white">Card Number</label>
          <div className="relative">
            <div className="absolute inset-y-0 start-0 flex items-center ps-3.5 pointer-events-none">
          ...
          <div className="relative">
            ...
            <input type="email" id="email-icon" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full ps-10 p-2.5  dark:bg-transparent dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="name@spendwise.com"/>
          </div>
