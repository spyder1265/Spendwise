  ...
  return (
    <div>
      <div className="flex h-screen w-full flex-col items-center justify-around pt-[72px] md:overflow-y-hidden">
        <div className="max-w-2xl rounded-lg border border-gray-200 p-6 shadow dark:border-gray-700">
          ...
          <div className="mb-6 ml-4 flex justify-evenly">
            <svg
