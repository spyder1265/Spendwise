...
const About: React.FC = () => {
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center pt-16 dark:text-gray-400">
        <div className="w-9/12 border-b border-gray-100 p-8 text-center">
          <h1 className="mb-5 mt-5 text-4xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
            About SpendWise
          </h1>
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className="mb-8 lg:mb-16 flex">
        <div>
          <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Our Mission</h2>
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">At SpendWise, our mission is to provide users with the tools and insights they need to make informed financial decisions, achieve their goals, and build a secure future. We are committed to simplifying the complexities of personal finance, making it accessible to everyone.</p>
          </div>
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <p className="text-gray-500 dark:text-gray-400">Easily track and categorize your expenses in real-time.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Budget Management</h3>
              <p className="text-gray-500 dark:text-gray-400">Set and manage budgets to stay on top of your financial goals.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Financial Insights</h3>
              <p className="text-gray-500 dark:text-gray-400">Gain valuable insights into your spending patterns and financial health.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Goal Tracking</h3>
              <p className="text-gray-500 dark:text-gray-400">Set and monitor your savings and financial goals with ease.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Secure and Private</h3>
              <p className="text-gray-500 dark:text-gray-400">Your financial data is encrypted and protected for your peace of mind.</p>
          </div>
          <div>
              <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
              ...
              <h3 className="mb-2 text-xl font-bold dark:text-white">Multiple Payment Methods</h3>
              <p className="text-gray-500 dark:text-gray-400">Support for transactions in multiple currencies to cater to a global customer base.</p>
          </div>
      </div>
  </div>
</section>
<div className="bg-white dark:bg-neutral-900">
          <div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:py-16">
            ...
            <p className="mb-8 text-lg font-normal dark:text-gray-400 sm:px-16 lg:px-48 lg:text-xl">
              Here at Spendwise we focus on markets where technology, innovation,
