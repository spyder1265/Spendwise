    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center pt-16 dark:text-gray-400">
        <div className="w-9/12 border-b border-gray-100 p-8 text-center">
          <h1 className="my-5 text-4xl font-extrabold leading-none tracking-tight text-gray-900 dark:text-white md:text-5xl lg:text-6xl">
            About SpendWise
          </h1>
          ...
          <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
            <div className="mb-8 flex lg:mb-16">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 sm:text-xl">
                  At SpendWise, our mission is to provide users with the tools
                  and insights they need to make informed financial decisions,
                  achieve their goals, and build a secure future. We are
                  committed to simplifying the complexities of personal finance,
            ...
            <div className="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Set and manage budgets to stay on top of your financial goals.
                </p>
              </div>
              <div>
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 lg:h-12 lg:w-12">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Set and monitor your savings and financial goals with ease.
                </p>
              </div>
              <div>
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-full bg-primary-100 dark:bg-primary-900 lg:h-12 lg:w-12">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Your financial data is encrypted and protected for your peace
                  of mind.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Support for transactions in multiple currencies to cater to a
        ...
        <div className="bg-white dark:bg-neutral-900">
          <div className="mx-auto max-w-screen-xl px-4 py-8 text-center lg:py-16">
            ...
            <p className="mb-8 text-lg font-normal dark:text-gray-400 sm:px-16 lg:px-48 lg:text-xl">
              Here at Spendwise we focus on markets where technology,
